...
public class IntermediaryDescriptorRemapper extends MixinIntermediaryDevRemapper {
	public final Map<String, String> methodNameDescMap = new HashMap<String, String>();

	@SuppressWarnings("unchecked")
	public IntermediaryDescriptorRemapper(TinyTree mappings, String from, String to) {
